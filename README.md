...
- [Tower Extension v0.2.1 — preview](https://github.com/vuxng/tower-unraid-plugin/releases/tag/v0.2.1)
- [Download tower.plg](https://github.com/vuxng/tower-unraid-plugin/releases/download/v0.2.1/tower.plg)
- [Download the SHA-256 checksum](https://github.com/vuxng/tower-unraid-plugin/releases/download/v0.2.1/tower.plg.sha256)

Version 0.2.1 is a preview. Automated tests cover packaging, permissions and simulated resource creation. Installation, API restart, reboot persistence and removal still need validation on a real Unraid server.
...
```text
https://github.com/vuxng/tower-unraid-plugin/releases/download/v0.2.1/tower.plg
```
